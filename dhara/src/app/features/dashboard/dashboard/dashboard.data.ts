...
export const QUICK_ACTIONS: QuickAction[] = [
  { id: 1, title: 'New Sale', subtitle: 'Create invoice', icon: 'point_of_sale', color: '#2563eb', route: '/sales' },
  { id: 2, title: 'Add Product', subtitle: 'Inventory', icon: 'inventory', color: '#16a34a', route: '/inventory' },
  { id: 3, title: 'Receive Payment', subtitle: 'Borrowers', icon: 'payments', color: '#ea580c', route: '/customers' },
  { id: 4, title: 'Purchase', subtitle: 'Stock Refill', icon: 'shopping_bag', color: '#9333ea', route: '/purchases' }
];
